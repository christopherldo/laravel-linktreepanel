        ...
        <form method="POST">
            ...
            <div class="mb-2">
                ...
                <div class="input-group">
                    ...
                    <input class="form-control" aria-describedby="emailHelp" {{ old('email') ? '' : 'autofocus' }}
                        required value="{{ old('email') }}" type="email" name="email" id="email">
                </div>
                <div id="emailHelp" class="mt-n1 form-text">Nunca compartilharemos seu e-mail com ninguém.</div>
            </div>
            ...
            <div class="mb-2">
                ...
                <div class="input-group">
                    ...
                    <input class="form-control" aria-describedby="passwordHelp" {{ old('email') ? 'autofocus' : '' }} required type="password"
                        name="password" id="password">
                </div>
                <div id="passwordHelp" class="mt-n1 form-text">Sua senha é criptografada. <br> Ela deve conter pelo menos 8 caracteres.</div>
            </div>
            ...
            Já é um usuário? <a href="{{ route('login') }}">Faça Login</a>
        </form>
    </div>
</body>
