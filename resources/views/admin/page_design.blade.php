...
@section('body')
    ...
    <form class="my-3" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-2">
            ...
            <div class="input-group">
                ...
                <input class="form-control" aria-describedby="slugHelp" required type="text" name="slug" id="slug"
                    minlength="2" maxlength="16" value="{{ old('slug') ?? $page->slug }}">
            </div>
        ...
        <div class="d-flex flex-wrap justify-content-center my-5">
            <div class="m-3">
                ...
                <div class="input-group">
                    ...
                    <input required type="color" class="form-control" style="height: 40px; width: 100px;" name="op_font_color"
                        id="op_font_color" value="{{ old('op_font_color') ?? $page->op_font_color }}">
                </div>
            </div>
            <div class="d-flex">
                <div class="m-3">
                    ...
                    <div class="input-group">
                        ...
                        <input required type="color" class="form-control" style="height: 40px; width: 100px;" name="op_bg_value_1"
                            id="op_bg_value_1" value="{{ old('op_bg_value_1') ?? $page->op_bg_value[0] }}">
                    </div>
                </div>
                <div class="m-3">
                    <label for="op_bg_value_2" class="form-label text-center">Cor secundária:</label>
                    <div class="input-group">
                        <span class="input-group-text" id="basic-addon4"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                height="16" fill="currentColor" class="bi bi-palette" viewBox="0 0 16 16">
                                <path
                                    d="M8 5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zm4 3a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zM5.5 7a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm.5 6a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z" />
                                <path
                        ...
                        <input required type="color" class="form-control" style="height: 40px; width: 100px;" name="op_bg_value_2"
                            id="op_bg_value_2" value="{{ old('op_bg_value_2') ?? $page->op_bg_value[1] }}">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-4">
            ...
            <div class="input-group">
                <span class="input-group-text" id="basic-addon5"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-type-h1" viewBox="0 0 16 16">
                    <path d="M8.637 13V3.669H7.379V7.62H2.758V3.67H1.5V13h1.258V8.728h4.62V13h1.259zm5.329 0V3.669h-1.244L10.5 5.316v1.265l2.16-1.565h.062V13h1.244z"/>
                  </svg></span>
                <input class="form-control" type="text" name="op_title" id="op_title"
                    minlength="2" maxlength="100" value="{{ old('op_title') ?? $page->op_title }}">
            </div>
        </div>
        ...
        <div class="mb-4">
            ...
            <textarea class="form-control" name="op_description" id="op_description"
                style="resize: none; height: 100px">{{ old('op_description') ?? $page->op_description }}</textarea>
        </div>
